# ═══════════════════════════════════════════════════════════════
# BioMoR — Hermetic Reproducibility Container
# ═══════════════════════════════════════════════════════════════
#
# Build:  docker build -t biomor .
# Test:   docker run --rm biomor test
# Pipeline (GPU): docker compose run --rm biomor pipeline
# Shell:  docker compose run --rm biomor bash
# ═══════════════════════════════════════════════════════════════

FROM pytorch/pytorch:2.0.1-cuda11.7-cudnn8-runtime

LABEL maintainer="BioMoR Team"
